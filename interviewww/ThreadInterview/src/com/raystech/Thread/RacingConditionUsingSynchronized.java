...
public class RacingConditionUsingSynchronized extends Thread {
	...
	public static void main(String[] args) {
		...
		RacingConditionUsingSynchronized r1 = new RacingConditionUsingSynchronized("vipul");
		RacingConditionUsingSynchronized r2 = new RacingConditionUsingSynchronized("baser");
